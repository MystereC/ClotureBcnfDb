...
/**
 * FunctionalDependency represents a functional dependency.
...
public class FunctionalDependency implements Comparable<FunctionalDependency>{
	 ...
	 * Theses sides will be parsed to extract a set of Attribute.
	 * @see Attribute class for more details.
	 * @param fd The FunctionalDependency to parse.
	 * @return an instance of FunctionalDependency.
	 */
